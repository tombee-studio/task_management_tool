...
def _task_info(**overrides):
    data = {
        "id": 123, "title": "T", "description": "D", "status": 1,
        "assignee": 2, "reporter": 3, "parent": None, "project": 1, "event": None,
    }
    data.update(overrides)
    kind_name = overrides.pop("kind_name", "feature")
    return TaskInfo(data, kind_name=kind_name)
