...
def strip_backtick_fences(content):
    """Remove leading and trailing backtick fence lines from file content.

    Claude sometimes wraps file content in an extra layer of backtick fences
    (e.g. 